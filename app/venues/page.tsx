            ...
            >
              <Card className="group overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-4">
                  <div className="mb-2">
                    <span className="text-xs text-muted-foreground uppercase tracking-wide">{venue.eventType}</span>
                  </div>
                  ...
                  {venue.metadata && (
                    <div className="flex items-center text-sm text-muted-foreground mb-2">
                      ...
                      {(() => {
                        try {
                          return JSON.parse(venue.metadata)?.location || 'Location not specified'
                        } catch {
