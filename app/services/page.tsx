...
function ServicesContent() {
    ...
    useEffect(() => {
        const hasFilters = searchQuery || serviceTypeFilter !== "all" || eventTypeFilter !== "all" || priceFilter !== "all";
        if (hasFilters) {
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <p className="text-sm text-muted-foreground">
                        {dataLoading ? "Loading services..." : `Showing ${services.length} services`}
                    </p>
                    {dataLoading && (
                                        ...
                                        <div className="flex items-start justify-between gap-2">
                                            ...
                                            <Badge
                                                ...
                                                className={cn(
                                                    ...
                                                    service.availability && "bg-green-100 text-green-800 border-green-200"
                                                )}
                                            >
                                                    ...
                                                    {service.images.slice(0, 3).map((imageUrl, index) => (
                                                        <div key={index} className="relative group">
                                                            <img
                                                                ...
                                                                style={{ viewTransitionName: `service-image-${service.id}-${index}` }}
                                                                onError={(e) => {
