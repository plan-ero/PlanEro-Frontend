...
import { Calendar, Clock, MapPin, Star, CalendarCheck, CheckCircle } from "lucide-react"
    ...
    <div className="container mx-auto py-10 px-4 md:px-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4 mt-8">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-4xl font-bold">{bookings.filter(b => b.status === "upcoming").length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-4xl font-bold">{bookings.filter(b => b.status === "completed").length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
  ...
  return (
    <Card className="overflow-hidden">
      <div className="h-48 bg-muted relative">
        ...
        <Badge 
          className={`absolute top-2 right-2 ${
            ...
            booking.status === "upcoming" ? "bg-blue-500" : "bg-red-500"
          }`}
        >
      ...
      <CardContent className="p-6">
        ...
        <p className="text-muted-foreground mb-4">Provided by {booking.vendorName}</p>
