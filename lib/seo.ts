  ...
  switch (page) {
    ...
    case "venues":
      return {
        ...
        description:
          "Discover amazing event venues for weddings, parties, corporate events and more. Browse hundreds of verified venues with photos, pricing, and availability.",
        keywords: [
          "event venues",
          "wedding venues",
          "party venues",
    ...
    case "vendors":
      return {
        ...
        description:
          "Connect with top-rated event vendors including photographers, caterers, decorators, DJs, and more. Read reviews and get quotes instantly.",
        keywords: [
          "event vendors",
          "wedding vendors",
    ...
    case "services":
      return {
        ...
        description:
          "Browse comprehensive event services including catering, photography, decoration, entertainment, transportation, and more. Compare prices and book online.",
        keywords: [
          "event services",
          "wedding services",
          "catering services",
    ...
    case "search":
      return {
        ...
        description:
          "Search and filter through thousands of venues, vendors, and services. Find exactly what you need for your perfect event.",
        keywords: [
          "event search",
          "venue search",
          "vendor search",
    ...
    case "about":
      return {
        ...
        description:
          "Learn about Planero's mission to simplify event planning. Discover our story, values, and commitment to making every event unforgettable.",
        keywords: [
          "about planero",
    ...
    case "venue-detail":
      ...
      return {
        title: venue?.name
          ? `${venue.name} - Event Venue | ${siteConfig.name}`
          : `Venue Details | ${siteConfig.name}`,
        description:
          venue?.description ||
          "Explore this amazing venue for your next event. View photos, amenities, pricing, and availability.",
        keywords: [
        ...
        openGraph: {
          ...
          description:
            venue?.description ||
            "Explore this amazing venue for your next event",
    ...
    case "vendor-detail":
      ...
      return {
        title: vendor?.name
          ? `${vendor.name} - Event Vendor | ${siteConfig.name}`
          : `Vendor Profile | ${siteConfig.name}`,
        description:
          vendor?.description ||
          "Professional event vendor providing quality services. View portfolio, reviews, and get instant quotes.",
        keywords: [
        ...
        openGraph: {
          ...
          description:
            vendor?.description ||
            "Professional event vendor providing quality services",
    ...
    case "service-detail":
      ...
      return {
        title: service?.name
          ? `${service.name} - Event Service | ${siteConfig.name}`
          : `Service Details | ${siteConfig.name}`,
        description:
          service?.description ||
          "Professional event service with competitive pricing. View details, photos, and book instantly.",
        keywords: [
        ...
        openGraph: {
          ...
          description:
            service?.description ||
            "Professional event service with competitive pricing",
